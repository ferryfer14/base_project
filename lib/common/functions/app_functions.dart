...
Future<void> scheduleAlarm(
    final title, final detail, final id, final interval) async {
  Map<String, String> payload = {"screen": 'transaction', "id": id.toString()};
...
Future<void> scheduleAlarmLocal(final title, final detail, final id,
    final id_booking, final interval) async {
  ...
  await flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      title,
      detail,
      tz.TZDateTime.now(tz.local).add(Duration(seconds: interval)),
      const NotificationDetails(
          android: AndroidNotificationDetails(
              'your channel id', 'your channel name',
              icon: '@drawable/icon_apps',
              channelDescription: 'your channel description')),
      payload: 'transaction, $id_booking',
