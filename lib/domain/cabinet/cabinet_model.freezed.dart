...
class _$_CabinetModel extends _CabinetModel {
  ...
  @override
  String toString() {
    return 'CabinetModel(id: $id, cabinet_id: $cabinet_id, cabinet_name: $cabinet_name, address: $address, battery_type: $battery_type, total_slots: $total_slots, ready: $ready, distance: $distance, status: $status, latitude: $latitude, longitude: $longitude, slots: $slots)';
  }
